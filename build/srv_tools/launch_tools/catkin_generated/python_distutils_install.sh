...
echo_and_run cd "/home/eba/multi_agent_ws/src/srv_tools/launch_tools"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/eba/multi_agent_ws/src/srv_tools/launch_tools/setup.py" \
     \
    build --build-base "/home/eba/multi_agent_ws/build/srv_tools/launch_tools" \
    install \
    --root="${DESTDIR-/}" \
