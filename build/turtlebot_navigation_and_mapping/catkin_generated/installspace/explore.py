...
class Explore:
    ...
    def __init__(self, robot_name):
        ...
        self.move_base = actionlib.SimpleActionClient(f'{robot_name}/move_base', MoveBaseAction)
        self.move_base.wait_for_server(rospy.Duration(5.0))
        rospy.logdebug(f"{robot_name} move_base is ready")
...
def main():
    ...
    robot_name = rospy.get_param("~robot_name", "tb1")
    explorer = Explore(robot_name)
    rospy.spin()
